document.addEventListener('DOMContentLoaded', function() {
  ...
  const onMouseMove = (e) => {
    ...
    const filterWidth = e.clientX - filterview.offsetLeft;
    const objectWidth = window.innerWidth - filterWidth - splitter.offsetWidth;

    // Set the new widths
    if (filterWidth > minWidth && objectWidth > minWidth) {
      filterview.style.width = `${filterWidth-25}px`;
      objectview.style.width = `${objectWidth-25}px`;
    }
  ...
  const urlEdit = null
  const urlEditEx = `${window.static_tab_edit_ex}`;
  const urlAdd = `${window.static_tab_add}`;

  const contentMap = {
      'bearbeiten': '<div class="mt-15"><div class="row jcl"><div class="col first-item"><p class="ext-content-heading">Medienstation</p><ul class="col-row-layout"><li class=""><a class="tab-link" href="' + urlAdd + '">Hinzufügen</a></li><li><a class="tab-link" href="#">Editieren</a></li></div><div class="col"><p class="ext-content-heading">Ausstellungen</p><ul class="col-row-layout"><li class=""><a class="tab-link" href="' + urlEditEx + '">Anzeigen</a></li></div></div></div>',
      'filter': "<div class='mt-15'><div class='row jcl'><div class='col first-item'><p class='ext-content-heading-red'>Medienarten</p><ul><li>Text</li><li>Bilder</li><li>Audio</li><li>Video</li><li>3D Objekt</li></div><div class='col'><p class='ext-content-heading-green'>Interaktionen</p><ul><li>Vergrößern</li><li>Vergleichen</li><li>Verknüpfen</li><li>Vergrößern</li><li>Fokussieren</li><li>Bewegen</li></div><div class='col'><p class='ext-content-heading-blue'>Visualisierungen</p><ul><li>Buch</li><li>Kacheln</li><li>Karte</li><li>Zeitstrahl</li></ul></div></div></div>",
